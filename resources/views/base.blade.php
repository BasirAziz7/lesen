        ...
        <ul class="list-unstyled topbar-menu float-end mb-0">
            ...
            <li class="dropdown notification-list topbar-dropdown d-none d-lg-block">
                <a class="nav-link dropdown-toggle arrow-none" data-bs-toggle="dropdown" id="topbar-languagedrop" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                    <img src="../images/flags/us.jpg" alt="user-image" class="me-1" height="12"> <span class="align-middle">English</span> <i class="mdi mdi-chevron-down align-middle"></i>
                </a>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="endbar-offcanvas" aria-labelledby="endbar-offcanvas">
...
<div class="end-bar">
    ...
    <div class="rightbar-content h-100" data-simplebar>
        ...
        <div class="p-3">
            ...
            <div class="form-check form-switch mb-1">
                <input class="form-check-input" type="checkbox" name="width" value="fluid" id="fluid-check" checked="checked">
    ...
    <script defer="defer" src="js/dashboardEcommerce.js"></script><script defer="defer" src="js/app.js"></script></body>
</html>
